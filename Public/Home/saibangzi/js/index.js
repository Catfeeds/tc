...
//icon历史记录      
            ...
            $("#icon-history").hover(function() {
                $(this).find(".icon-history").css("display", "block");
            }, function() {
                $(this).find(".icon-history").css("display", "none");
            });

            $("#touxiang").hover(function() {
            	if ($('#t-l-1').css("display") === "none") {
					$("#t-l-1").css("display", "block");
            	}
            }, function() {
            	if ($('#t-l-1').css("display") === "block") {
					$("#t-l-1").css("display", "none");
					$("#t-l-2").css("display", "none");
            	}
            });
            ...
            $(window).bind("load", function() {
                ...
                　　function positionFooter() {
                    ...
                    　　if ( ($('.jiaoyazi')[0].offsetTop+footerHeight) < $(window).height()) {
                       　　 $footer.css({
                           　　 position: "absolute",
                                top: footerTop
                       　　 });
