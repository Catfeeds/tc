    ...
    $.fn.ckSlide = function(opts) {
        ...
        this.each(function() {
            ...
            $(window).resize(function() {
              $(".ck-slide-dir ul li").width($(".ck-slide-dir").width());
              $(".ck-slide-dir ul li img").width($(".ck-slide-dir").width());
              if(index > 0){
                var width = $(".ck-slide-dir").width();
                $('.ck-slide-wrapper').stop();
                $(".ck-slide-wrapper").css("margin-left",-(index*width));

              }
              switch (opts.dir) {
                case "x":
                    opts['width'] = $(".ck-slide-dir ul li").width();
                    slidewrap.css({
                        'width': count * opts['width']
                    });
                    slide.css({
