...
// | 请求类型     | 
// +----------------------------------------------------------------------
// | 参数         | data(数据)、code(状态码)、message(说明)
// +----------------------------------------------------------------------
...
// | 参数         | data(数据)、code(状态码)、message(说明)
// +----------------------------------------------------------------------
    public function templateApi($data,$code,$message){
        if(!$data){
            $data=(object)null;
        }
        $result['result']=$data;
...
// +----------------------------------------------------------------------
    ...
    public function bankCard_judge($bankcard){
        $banknum=substr($bankcard,0,6);
        $bankList =array(
            '621098' => '邮储银行-绿卡通-借记卡',
...
// +----------------------------------------------------------------------
    ...
    public function havePage($tabname,$where,$order,$page,$num,$field){
        $config = array(
    ...
    //图片拼接url
    public function Splicingimg($img){
        if($img==''){
            $date=array();
        }else{
            $arr=explode(",",$img);
    ...
    //输入数据为空返回空字符串
    public function emptyString($data){
        if($data){
            return $data;
        }else{
            $data='';
